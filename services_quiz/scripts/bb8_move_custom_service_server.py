...
import rospy
from services_quiz.srv import MyCustomServiceMessage, MyCustomServiceMessageResponse, BB8CustomServiceMessage, BB8CustomServiceMessageResponse
import time
...
def square(request):
    ...
    return  True # the service Response class, in this case MyCustomServiceMessageResponse
